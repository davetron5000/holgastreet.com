...
Roll = ImmutableStruct.new(:name, [:pictures], :theme, :description, :roll_number) do
  ...
  def self.from_pictures_and_data(name: , roll_number: , pictures:, data_file: )
    ...
    self.new(name: name, pictures: pictures, roll_number: roll_number, theme: roll_data["theme"], description: roll_data["description"])
  end
